# xuexi
итоги недели: освоены DOM, events, калькулятор сделан на 30%
нужно узнать:
1.Разница между innerText, innerHTML и value в JavaScript.
2.Разница между parseInt, parseFloat и Number().(https://learn.javascript.ru/primitives-methods)
